...
- ## StereoSimulator
    ...
    <figcaption style="text-align: center; font-style: italic;">Data generation pipeline for videos from generative models</figcaption>
    </figure>
...
- ## Results
    ...
    <figcaption style="font-style: italic; margin-top: 8px;">Mirror Illusions</figcaption>
    </figure>

    <figure style="text-align: center;">
    <img src="./Fig/3d-Illusion-vis2.jpg" alt="model" style="width: 100%;">
    <figcaption style="font-style: italic; margin-top: 8px;">Picture Illusions</figcaption>
    </figure>